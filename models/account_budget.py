...
class CrossoveredBudget(models.Model):
    ...
    name = fields.Char('Nombre Presupuesto', required=True, states={'done': [('readonly', True)]})
    user_id = fields.Many2one('res.users', 'Responsable', default=lambda self: self.env.user, oldname='creating_user_id')
...
class CrossoveredBudgetLines(models.Model):
    ...
    _description = "Lineas de Presupuesto"
    ...
    analytic_account_id = fields.Many2one('account.analytic.account', 'Gupot')
    analytic_group_id = fields.Many2one('account.analytic.group', 'Grupo Analitico', related='analytic_account_id.group_id', readonly=True)
    general_budget_id = fields.Many2one('account.budget.post', 'Posicion Presupuestaria')
    ...
    practical_amount = fields.Monetary(
        compute='_compute_practical_amount', string='Monto Práctico', help="Amount really earned/spent.")
    theoritical_amount = fields.Monetary(
        compute='_compute_theoritical_amount', string='Monto Teórico',
        help="Amount you are supposed to have earned/spent at this date.")
    percentage = fields.Float(
        compute='_compute_percentage', string='     ',
